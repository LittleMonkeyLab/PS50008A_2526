...
<!-- TODO: Introduce correlational thinking -->
...
<!-- TODO: Explain positive vs negative -->
...
::: {.incremental}
- **Perfect**: All points on a line (r = +/- 1.0)
- **Strong**: Points cluster tightly around line
- **Weak**: Points scattered loosely
- **Zero**: No linear pattern (r = 0)
:::
...
Correlation measures LINEAR relationships only. A strong curved relationship might show r near 0!
:::

::: {.fragment}
<!-- TODO: Add plot showing linear, curvilinear, and no relationship -->
:::
...
```{r}
#| eval: false
# TODO: Add R code creating scatterplots showing
# positive, negative, strong, weak correlations
```

## What to Look For

<!-- TODO: Pattern recognition guide -->
...
<!-- TODO: Discuss outlier effects -->

::: {.callout-warning}
## Warning
A single outlier can dramatically change a correlation coefficient. Always visualise your data first!
:::

::: {.fragment}
<!-- TODO: Add plot showing outlier impact -->
:::
...
<!-- TODO: Introduce need for alternatives -->
...
<!-- TODO: Add entertaining examples -->
...
<!-- TODO: Discuss causal inference criteria -->
