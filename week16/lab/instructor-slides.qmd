...
|---|---|---|---|
| **Research Plan** | 20% | Fri 27 Feb, 12 noon | **Due Fri 27 Feb** |
| **MCQ Exam** | 20% | Wed 11 Mar, ~1 hour (in lecture) | Week 18 |
| **EDS Assignment** | 20% | Fri 20 Mar, 12 noon (~1-2 hours) | Week 19 |
| **Research Report** | 40% | 1 May, 12 noon | Post-Easter |

::: {.fragment}
::: {.callout-important}
## Research Plan
Your first submission is due **Friday 27 February at noon**. Make sure it's uploaded to Learn before the deadline.
:::
:::
...
## What You'll Get Back: Data Analysis I — Layout examples

After your group collects data, I'll run the analysis and return a one-page summary like this — **personalised to your group**. The slides that follow show example layouts only (between-subjects, paired / within-subjects).

---

## TedImoBea (between-subjects layout)

![](analysis-preview-TedImoBea.png){width="75%" fig-align="center"}

---

## JFKz Girlies (between-subjects layout)

![](analysis-preview-JFKz-Girlies.png){width="75%" fig-align="center"}

---

## DNM (paired / within-subjects layout)

![](analysis-preview-DNM.png){width="75%" fig-align="center"}

---

## The Boyz (between-subjects — two columns = two independent groups)

![](analysis-preview-The-Boyz.png){width="75%" fig-align="center"}
...
1. **Form your group** (3–4 is ideal, but the key thing is you join one)
2. **Choose your project topic** — from the [example list](https://littlemonkeylab.github.io/PS50008A_2526/project/group-project-options.html) or create your own
3. **Find a key paper** — something to anchor your methodology or hypothesis
:::
...
Enter your group members and any preliminary topic ideas.
:::
...
::: {.incremental}
- **Choose from the [9 example topics](https://littlemonkeylab.github.io/PS50008A_2526/project/group-project-options.html)** — fully scoped, ready to go
...
::: {.callout-important}
## Key Requirement
Your topic must be testable using a **two-group t-test** (between-subjects or within-subjects). Think small-scale: ~15–20 participants, short tasks (~5–10 min per person).
:::
:::
...
I've included some starting-point papers on Learn for each example topic:

**[Papers folder on Learn](https://learn.gold.ac.uk/mod/folder/view.php?id=1795121)** — a couple of papers per topic

::: {.fragment}
They're not all perfect — a quick literature search may turn up something more relevant, more recent, or a better methodological match. Use them as a springboard.
:::

::: {.fragment}
::: {.callout-note}
## More Resources
- **[Template documents on Learn](https://learn.gold.ac.uk/mod/folder/view.php?id=1795124)** — with worked examples
- **[Project Toolkit](https://littlemonkeylab.github.io/PS50008A_2526/project/project-toolkit.html)** — overview of each project
:::
:::
...
- [ ] Chosen your project topic (from list or your own)
