...
subtitle: "APA Report Writing & Your Research Project"
---

::: {.callout-tip}
## What This Chapter Covers
This reading accompanies the Week 16 lecture on APA report writing. It explains the structure of an APA-style lab report, how your Research Plan maps onto the Method section, and the writing conventions you'll need for the Research Report due 1 April.

- The sections of an APA lab report and what goes in each
- How your Research Plan IS your Method section
- APA writing conventions (tense, person, statistical notation)
- Common mistakes and how to avoid them
:::

This chapter is your reference guide for writing in psychology. You'll come back to it repeatedly over the coming weeks as you build your Research Report section by section.
...
Your Research Report (due Friday 1 April, 2,000 words) will follow this format exactly.
...
The Research Plan you're submitting this week covers the same four subsections. Everything you write for the Research Plan feeds directly into your Research Report.
:::
...
We'll cover Results reporting in full detail in Week 19.
...
We'll cover Discussion writing in Week 20.
...
## Your Research Plan → Your Research Report

Your Research Plan (due Friday 27 February) is the first building block of your Research Report (due Friday 1 April). Here's how each component maps:

| Research Plan component | Becomes this in the Report |
|------------------------|---------------------------|
| Hypothesis | End of Introduction + referenced in Design |
| Design choice + justification | **Design** subsection of Method |
| Participant plan | **Participants** subsection |
| Materials description | **Materials** subsection |
| Step-by-step procedure | **Procedure** subsection |
| Statistical test choice | Referenced in Design, used in Results |

Over the remaining weeks, you'll add the other sections:

| Week | What you'll write |
|------|-------------------|
| **16 (this week)** | Method section (= Research Plan) |
| **17** | Begin Introduction (literature review) |
| **18-19** | Results (after data collection) |
| **20** | Discussion |
| **Easter** | Abstract, Title, References, polish |
| **1 April** | Submit Research Report (2,000 words) |

---

## Checklist Before Submitting Your Research Plan

Use this checklist before submitting on Friday:

- [ ] **Hypothesis**: Clear, specific, and testable? One-tailed or two-tailed stated?
- [ ] **Design**: Type stated AND justified? IV and DV clearly identified?
- [ ] **Participants**: Number, recruitment method, and demographics included?
- [ ] **Materials**: All stimuli/measures described with examples?
- [ ] **Procedure**: Chronological, step-by-step? Includes timing?
- [ ] **Ethics**: Informed consent and debriefing mentioned?
- [ ] **Statistical test**: Named AND justified?
- [ ] **Writing**: Past tense? Third person? Appropriate academic tone?
- [ ] **Word count**: Within 1,000–1,200 words?
