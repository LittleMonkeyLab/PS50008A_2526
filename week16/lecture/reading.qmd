...
This reading accompanies the Week 16 lecture on APA report writing. It explains the structure of an APA-style lab report, how to write a Method section (using your Research Plan as a worked example), and the writing conventions you'll need for academic psychology writing.
...
Your group project builds week by week:

| Week | What happens |
|------|-------------|
| **16 (this week)** | Form groups ([register here](https://forms.office.com/Pages/ResponsePage.aspx?id=Px9DDcEgHEaVikaynU4CG8gqdkQ5QElOkXjIDHSz7DVURjBMUUo1TFNBUElCUEpGWVlZRzFSMDdYVy4u){target="_blank"}), receive project topic, begin literature review |
| **17** | Finalise methodology and design |
| **18** | Develop procedure and materials |
| **19** | Collect data |
| **20** | Analyse data, begin writing |
| **Easter** | Individual write-up |
| **mid-late April** | Submit Research Report (2,500 words, 12 noon) |
