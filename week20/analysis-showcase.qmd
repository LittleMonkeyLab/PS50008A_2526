...
There is **no live lecture** this week. Use this page instead: it shows **preview images** of the analysis run on your group’s pooled data (Data Analysis I), plus **two extra illustrative previews** (Simone’s Pantheon and Perfume) in the same layout. Use the numbers and plots here to help draft your **Results** section in APA format — see the **Thursday lab** materials for integration tips.
:::
