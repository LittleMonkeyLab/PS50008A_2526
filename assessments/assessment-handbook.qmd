...
| Research Report | 40% | mid-late April| 2,500 word APA report |
...
| Week | Topic | How It Helps |
|---|---|---|
| 11 | The Big Picture | Design framework overview |
| 12 | Variables & Hypotheses | IVs, DVs, hypothesis types |
| 13 | Experimental Design | Between/within/matched designs |
| 14 | *t*-tests | Paired and independent tests |
| 15 | Correlation & Regression | Correlational design and tests |
| 16 | Non-parametric Tests | Mann-Whitney, Wilcoxon, Spearman's |
| 17 | Revision & Integration | Pulling it all together |
...
5. **Run the example MCQ in exam conditions** you will be able to do pretty well, just by attending class
...
- Reporting the wrong or imprecise numbers - you only have a couple of results to report, so be super-careful
...
|---|---|
| **Weight** | 40% |
| **Deadline** | Date TBC mid-late April |
| **Submission** | Via Moodle |
