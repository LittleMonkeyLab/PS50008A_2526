...
Although I have tried to provide detailed readings here, so that you don't have to lean on textbooks, sometimes a new voice is handy to help grapple with a new topic. Both textbooks below are great and are available as e-books via the Goldsmiths Library:
...
Working in groups is a core part of this module. Later in the term, your group (comprising 3-4 students) will design and run your own study, collect real data, and write it up as a research report. The group project is a substantial part of your assessment, and the quality of your collaboration directly affects your experience and your grade.
...
|------|---------------------|---------------|
| 11 | Grow your own data (DataLab) | — |
| 12-15 | Develop research skills and design knowledge | Reporting Psychology |
| — | *Reading Week* | — |
| 16-17 | Form groups, choose topic, draft project documents | Methods & Introduction |
| 18 | Finalise materials, practice run | Procedure & Materials |
| 19 | Data collection | Results |
| 20 | Gordon returns analysed data | Discussion & Report |
...
- **Research Report** (due 1 May 2026) — Individual write-up of group data (individual)
...
::: {.callout-warning}
## DataLab
Attendance at Week 11 was essential for DataLab participation. This generated the dataset used throughout the term. Your own data forms the basis of all lab activities and analyses.
:::
