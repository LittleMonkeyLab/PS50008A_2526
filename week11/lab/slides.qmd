...
## STUDY: Lab A (Silence) {background-color="#4ECDC4" visibility="hidden"}
...
## STUDY: Lab B (Mozart) {background-color="#4ECDC4" visibility="hidden"}
...
- But real randomness has streaks
...
- Most people slightly overconfident
...
- Note any issues
- Lab A: Silence + Abstract
- Lab B: Mozart + Concrete
:::
